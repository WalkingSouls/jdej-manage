...
public class MD5Util {
    ...
    public static String encrypt(String password) {
        ...
        try {
            ...
            passwordMd5 = byteToHexString(bytes);
     ...
     * @return
     */
    public static boolean verifyPass(String passInput,String passDB) {
        String encryptInput = encrypt(passInput);
        if(encryptInput.equals(passDB)){
            return true;
        }
        return false;
    }
